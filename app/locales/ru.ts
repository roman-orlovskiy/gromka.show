export default {
  ...
  contacts: {
    ...
    consent: 'Нажимая отправить вы соглашаетесь с&nbsp;политикой&nbsp;конфиденциальности',
    errors: {
